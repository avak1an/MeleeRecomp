...
PFN_glGenRenderbuffers pc_glGenRenderbuffers;
PFN_glDeleteRenderbuffers pc_glDeleteRenderbuffers;
PFN_glBindRenderbuffer pc_glBindRenderbuffer;
PFN_glRenderbufferStorage pc_glRenderbufferStorage;
PFN_glRenderbufferStorageMultisample pc_glRenderbufferStorageMultisample;
PFN_glFramebufferRenderbuffer pc_glFramebufferRenderbuffer;
PFN_glDeleteFramebuffers pc_glDeleteFramebuffers;
