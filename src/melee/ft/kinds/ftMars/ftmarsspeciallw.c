...
STATIC_CONST(MotionFlags, ftMs_MF_SpecialLw_Coll, ftCommon_GroundAirColl_MF | Ft_MF_KeepColAnimHitStatus | Ft_MF_SkipHit);
STATIC_CONST(MotionFlags, ftMs_MF_SpecialLwHit_Coll, ftMs_MF_SpecialLw_Coll | Ft_MF_KeepGfx);
