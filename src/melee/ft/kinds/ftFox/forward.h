...
STATIC_CONST(MotionFlags, ftFx_MF_Appeal, Ft_MF_KeepGfx | Ft_MF_SkipModel | Ft_MF_SkipAnimVel | Ft_MF_Unk06);

STATIC_CONST(MotionFlags, ftFx_MF_Special, Ft_MF_SkipModel | Ft_MF_SkipItemVis | Ft_MF_UnkUpdatePhys |
    Ft_MF_FreezeState);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialN, ftFx_MF_Special | Ft_MF_KeepFastFall | Ft_MF_SkipThrowException);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialS, ftFx_MF_Special | Ft_MF_KeepGfx | Ft_MF_KeepSfx);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialHi, ftFx_MF_SpecialS | Ft_MF_KeepFastFall);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialAirN, ftFx_MF_SpecialN | Ft_MF_SkipParasol);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialAirS, ftFx_MF_SpecialS | Ft_MF_SkipParasol);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialAirHiHold, ftFx_MF_SpecialHi | Ft_MF_SkipParasol);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialLw, ftFx_MF_Special | Ft_MF_KeepColAnimHitStatus | Ft_MF_SkipColAnim);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialAirLw, ftFx_MF_SpecialLw | Ft_MF_SkipParasol);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialNLoop, ftFx_MF_SpecialN | Ft_MF_Unk19);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialAirNLoop, ftFx_MF_SpecialNLoop | Ft_MF_SkipParasol);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialLwLoop, ftFx_MF_SpecialLw | Ft_MF_Unk19);

STATIC_CONST(MotionFlags, ftFx_MF_SpecialAirLwLoop, ftFx_MF_SpecialLwLoop | Ft_MF_SkipParasol);
