 ...
 * runs straight into hsd_804D1148; on the console the linker places them
 * back to back. Give them one block here (see hsd_3A94.h for the aliases). */
u8 hsd_card_area[0x10 + 0x80 * 0x9 * 4];
#else
